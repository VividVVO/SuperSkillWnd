...
%CSC% /nologo /utf8output /out:%OUT% /target:exe /platform:anycpu /reference:System.dll /reference:System.Core.dll /reference:System.Xml.dll /reference:System.Xml.Linq.dll ^
  Program.cs ^
