@echo off
call "C:\Program Files\Microsoft Visual Studio\18\Professional\VC\Auxiliary\Build\vcvars32.bat" >nul 2>&1
if errorlevel 1 (
...
del /f /q build\Debug\vc140.pdb 2>nul
